...
This application runs in the browser.HTML and CSS and Javascript documents created a calendar table planner, using Javascript to make dynamic changes to an HTML document and using window storage to save information input data within the time slot the user selected 
